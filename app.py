...
if selection == "1. Executive Dashboard":
    ...
    with g1:
        fig_g = go.Figure(go.Indicator(
            mode="gauge+number", value=never_succ, number={'suffix': "%", 'font': {'size': 50}},
            title={'text': "Money Never Runs Out<br><span style='font-size:1.3em;color:gray'>(solvent through your lifetime)</span>"},
